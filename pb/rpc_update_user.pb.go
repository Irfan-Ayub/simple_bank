...
const file_rpc_update_user_proto_rawDesc = "" +
	...
	"\x04user\x18\x01 \x01(\v2\b.pb.UserR\x04userB&Z$github.com/Irfan-Ayub/simple_bank/pbb\x06proto3"
...
var (
	file_rpc_update_user_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
	file_rpc_update_user_proto_goTypes  = []any{
