...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x15rpc_create_user.proto\x1a\x15rpc_update_user.proto\x1a\x14rpc_login_user.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x1cgoogle/api/annotations.proto2\xce\x03\n" +
	"\n" +
	...
	"\n" +
	"UpdateUser\x12\x15.pb.UpdateUserRequest\x1a\x16.pb.UpdateUserResponse\"G\x92A*\x12\vUpdate user\x1a\x1bUse this API to update user\x82\xd3\xe4\x93\x02\x14:\x01*2\x0f/v1/update_user\x12\xa9\x01\n" +
	"\tLoginUser\x12\x14.pb.LoginUserRequest\x1a\x15.pb.LoginUserResponse\"o\x92AS\x12\n" +
	"login user\x1aEUse this API to login user and get the access token and refresh token\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/login_userB\x8a\x01\x92Aa\x12_\n" +
	"\x0fSimple Bank API\"G\n" +
	"\n" +
	"Irfan Ayub\x12!github.com/Irfan-Ayub/simple_bank\x1a\x16irfanayub995@gmail.com2\x031.1Z$github.com/Irfan-Ayub/simple_bank/pbb\x06proto3"
